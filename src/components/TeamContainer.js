    ...
    <div className="p-6 min-h-screen flex flex-col items-center bg-gray-100">
      <div className="flex flex-col gap-8 w-full max-w-4xl">
        {users.map((user) => (
          <div
            key={user.id}
            className="relative border border-gray-300 border-opacity-70 rounded-2xl p-6 mb-4 bg-white shadow-xl transition-transform transform hover:scale-105 hover:shadow-2xl overflow-hidden border-pink-600"
          >
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm font-semibold px-4 py-1 rounded-full shadow-lg bg-gradient-to-r from-green-400 to-blue-500 text-white transition-transform duration-300 transform hover:scale-105">
                  Tech Lead
                </span>
              </div>
              ...
              <div className="flex items-end justify-start mt-4">
                <button className="relative z-10 mt-2 bg-blue-600 text-white px-6 py-2 rounded-lg shadow-md hover:bg-blue-700 transition-transform duration-300 transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-blue-300">
                  View Profile
                  <span className="absolute inset-0 bg-blue-500 opacity-0 hover:opacity-30 rounded-lg transition-opacity duration-500" />
                </button>
              </div>
            </div>
          </div>
...
//   return (
//     <div className="p-6 bg-gradient-to-br from-white via-gray-100 to-gray-200 min-h-screen flex flex-col items-center">
//       <div className="flex flex-col gap-8 w-full max-w-4xl">
//         {users.map((user) => (
//           <div
//             key={user.id}
//             className="relative border border-gray-300 border-opacity-70 rounded-2xl p-6 mb-4 bg-gradient-to-br from-white via-gray-100 to-gray-200 shadow-xl transition-transform transform hover:scale-105 hover:shadow-2xl backdrop-filter backdrop-blur-md bg-opacity-80 overflow-hidden"
//           >
//             {/* Animated Border Layer */}
//             <div className="absolute inset-0 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 opacity-20 transition-opacity duration-500 pointer-events-none" />
...
//                   <span className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-600 opacity-0 hover:opacity-30 rounded-lg transition-opacity duration-500" />
//                 </button>
//               </div>
//             </div>
//           </div>
